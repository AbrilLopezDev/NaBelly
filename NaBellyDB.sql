...
nombreusuario varchar(16),
constraint pk_favoritos primary key (idreceta, nombreusuario),
constraint fk_favoritos_recetas foreign key (idreceta) references recetas (idreceta),
constraint fk_favoritos_usuarios foreign key (nombreusuario) references usuarios (nombreusuario)
);
...
8, 'BUD', NOW(), 'https://abrillopezdev.github.io/fotosRecetas/budinArandano.png'),
...
8, 'BUD', NOW(), 'https://abrillopezdev.github.io/fotosRecetas/budinBanana.png'),
...
8, 'BUD', NOW(), 'https://abrillopezdev.github.io/fotosRecetas/budinChocolate.png');
...
2, 'ENS', NOW(), 'https://abrillopezdev.github.io/fotosRecetas/ensaladaAtun.png'),
...
2, 'ENS', NOW(), 'https://abrillopezdev.github.io/fotosRecetas/ensaladaCaprese.png'),
...
2, 'ENS', NOW(), 'https://abrillopezdev.github.io/fotosRecetas/ensaladaCesar.png' ),
...
2, 'ENS', NOW(), 'https://abrillopezdev.github.io/fotosRecetas/ensaladaGarbanzos.png'),
...
2, 'ENS', NOW(), 'https://abrillopezdev.github.io/fotosRecetas/ensaladaGriega.png'),
...
2, 'ENS', NOW(), 'https://abrillopezdev.github.io/fotosRecetas/ensaladaPollo.png'),
...
2, 'ENS', NOW(), 'https://abrillopezdev.github.io/fotosRecetas/ensaladaQuinoa.png'),
...
2, 'ENS', NOW(), 'https://abrillopezdev.github.io/fotosRecetas/ensaladaRusa.png'),
...
2, 'ENS', NOW(), 'https://abrillopezdev.github.io/fotosRecetas/ensaladaThai.png'),
...
2, 'ENS', NOW(), 'https://abrillopezdev.github.io/fotosRecetas/ensaladaWaldorf.png');
